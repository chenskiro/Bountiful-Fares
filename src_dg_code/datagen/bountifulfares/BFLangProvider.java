...
public class BFLangProvider extends LanguageProvider {
    ...
    public void addTranslations() {
        ...
        generate( BFBlocks.HANGING_APPLE, "Apple");
        add( BFBlocks.HANGING_ORANGE, "Orange");
        generate( BFBlocks.HANGING_LEMON, "Lemon");
        generate( BFBlocks.HANGING_PLUM, "Plum");
        generate( BFBlocks.HANGING_GOLDEN_APPLE, "Golden Apple");
        generate( BFBlocks.HANGING_WITHERED_GOLDEN_APPLE, "Withered Golden Apple");



        generate( BFBlocks.HOARY_APPLE_SAPLING_CROP, "Hoary Apple Sapling");
        generate( BFItems.HOARY_CHEST_BOAT, "Hoary Boat with Chest");
        generate( BFBlocks.HANGING_HOARY_APPLE, "Hoary Apple");

        generate( BFBlocks.CERAMIC_CLAY_BLOCK, "Block of Ceramic Clay");


        generate( BFItems.WALNUT_CHEST_BOAT, "Walnut Boat with Chest");

        generate( BFBlocks.HANGING_WALNUTS, "Walnuts");


        generate( BFBlocks.WALL_PALM_FROND, "Palm Frond");

        generate( BFBlocks.HOARY_SIGN, "Hoary Sign");
        generate( BFBlocks.HOARY_WALL_SIGN, "Hoary Sign");
        generate( BFItems.HOARY_SIGN, "Hoary Sign");
        generate( BFBlocks.HOARY_HANGING_SIGN, "Hoary Hanging Sign");
        generate( BFBlocks.HOARY_WALL_HANGING_SIGN, "Hoary Hanging Sign");
        generate( BFItems.HOARY_HANGING_SIGN, "Hoary Hanging Sign");

        generate( BFBlocks.WALNUT_SIGN, "Walnut Sign");
        generate( BFBlocks.WALNUT_WALL_SIGN, "Walnut Sign");
        generate( BFItems.WALNUT_SIGN, "Walnut Sign");
        generate( BFBlocks.WALNUT_HANGING_SIGN, "Walnut Hanging Sign");
        generate( BFBlocks.WALNUT_WALL_HANGING_SIGN, "Walnut Hanging Sign");
        generate( BFItems.WALNUT_HANGING_SIGN, "Walnut Hanging Sign");
        ...
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.OAK), "Oak Trellis");
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.SPRUCE));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.BIRCH));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.JUNGLE));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.ACACIA));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.DARK_OAK));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.MANGROVE));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.CHERRY));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.BAMBOO));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.WALNUT));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.HOARY));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.CRIMSON));
        generate( TrellisUtil.getTrellisFromVariant(BFTrellises.WARPED));

        generate( TrellisUtil.getTrellisFromVariant(ExcessiveBuildingBlocks.ANCIENT));

        generate( TrellisUtil.getTrellisFromVariant(MintBlocks.WINTERGREEN));

        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.ASPEN));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.CEDAR));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.COCONUT));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.CYPRESS));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.FIR));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.GHAF));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.JOSHUA));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.LARCH));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.MAHOGANY));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.MAPLE));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.OLIVE));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.PALO_VERDE));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.SAXAUL));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.SUGI));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.WILLOW));
        generate( TrellisUtil.getTrellisFromVariant(NaturesSpiritBlocks.WISTERIA));

        generate( TrellisUtil.getTrellisFromVariant(SpawnBlocks.ROTTEN));

        generate( TrellisUtil.getTrellisFromVariant(ArtsAndCraftsBlocks.CORK));

        generate( TrellisUtil.getTrellisFromVariant(DungeonsDelightBlocks.WORMWOOD));



        generate( BFBlocks.MAIZE_CROP, "Maize");
...
//        generate( "effect.bountifulfares.gorging", "Gorging");
        ...
        generateJackOStraw( BFBlocks.RED_JACK_O_STRAW, "Red");
        generateJackOStraw( BFBlocks.ORANGE_JACK_O_STRAW, "Orange");
        generateJackOStraw( BFBlocks.YELLOW_JACK_O_STRAW, "Yellow");
        generateJackOStraw( BFBlocks.LIME_JACK_O_STRAW, "Lime");
        generateJackOStraw( BFBlocks.GREEN_JACK_O_STRAW, "Green");
        generateJackOStraw( BFBlocks.CYAN_JACK_O_STRAW, "Cyan");
        generateJackOStraw( BFBlocks.LIGHT_BLUE_JACK_O_STRAW, "Light Blue");
        generateJackOStraw( BFBlocks.BLUE_JACK_O_STRAW, "Blue");
        generateJackOStraw( BFBlocks.PURPLE_JACK_O_STRAW, "Purple");
        generateJackOStraw( BFBlocks.MAGENTA_JACK_O_STRAW, "Magenta");
        generateJackOStraw( BFBlocks.PINK_JACK_O_STRAW, "Pink");
        generateJackOStraw( BFBlocks.WHITE_JACK_O_STRAW, "White");
        generateJackOStraw( BFBlocks.LIGHT_GRAY_JACK_O_STRAW, "Light Gray");
        generateJackOStraw( BFBlocks.GRAY_JACK_O_STRAW, "Gray");
        generateJackOStraw( BFBlocks.BLACK_JACK_O_STRAW, "Black");
        generateJackOStraw( BFBlocks.BROWN_JACK_O_STRAW, "Brown");

        generateJackOStraw( MintBlocks.ACORN_JACK_O_STRAW, "Acorn");
        generateJackOStraw( MintBlocks.AMBER_JACK_O_STRAW, "Amber");
        generateJackOStraw( MintBlocks.ARTICHOKE_JACK_O_STRAW, "Artichoke");
        generateJackOStraw( MintBlocks.BANANA_JACK_O_STRAW, "Banana");
        generateJackOStraw( MintBlocks.CERULEAN_JACK_O_STRAW, "Cerulean");
        generateJackOStraw( MintBlocks.FUCHSIA_JACK_O_STRAW, "Fuchsia");
        generateJackOStraw( MintBlocks.GRAPE_JACK_O_STRAW, "Grape");
        generateJackOStraw( MintBlocks.INDIGO_JACK_O_STRAW, "Indigo");
        generateJackOStraw( MintBlocks.MAROON_JACK_O_STRAW, "Maroon");
        generateJackOStraw( MintBlocks.MAUVE_JACK_O_STRAW, "Mauve");
        generateJackOStraw( MintBlocks.MINT_JACK_O_STRAW, "Mint");
        generateJackOStraw( MintBlocks.MOLD_JACK_O_STRAW, "Mold");
        generateJackOStraw( MintBlocks.NAVY_JACK_O_STRAW, "Navy");
        generateJackOStraw( MintBlocks.PEACH_JACK_O_STRAW, "Peach");
        generateJackOStraw( MintBlocks.PERIWINKLE_JACK_O_STRAW, "Periwinkle");
        generateJackOStraw( MintBlocks.SAGE_JACK_O_STRAW, "Sage");
        generateJackOStraw( MintBlocks.SAP_JACK_O_STRAW, "Sap");
        generateJackOStraw( MintBlocks.SHAMROCK_JACK_O_STRAW, "Shamrock");
        generateJackOStraw( MintBlocks.VELVET_JACK_O_STRAW, "Velvet");
        generateJackOStraw( MintBlocks.VERMILION_JACK_O_STRAW, "Vermilion");

        generateJackOStraw( DyeDepotBlocks.MAROON_JACK_O_STRAW, "Maroon");
        generateJackOStraw( DyeDepotBlocks.ROSE_JACK_O_STRAW, "Rose");
        generateJackOStraw( DyeDepotBlocks.CORAL_JACK_O_STRAW, "Coral");
        generateJackOStraw( DyeDepotBlocks.GINGER_JACK_O_STRAW, "Ginger");
        generateJackOStraw( DyeDepotBlocks.TAN_JACK_O_STRAW, "Tan");
        generateJackOStraw( DyeDepotBlocks.BEIGE_JACK_O_STRAW, "Beige");
        generateJackOStraw( DyeDepotBlocks.AMBER_JACK_O_STRAW, "Amber");
        generateJackOStraw( DyeDepotBlocks.OLIVE_JACK_O_STRAW, "Olive");
        generateJackOStraw( DyeDepotBlocks.FOREST_JACK_O_STRAW, "Forest");
        generateJackOStraw( DyeDepotBlocks.VERDANT_JACK_O_STRAW, "Verdant");
        generateJackOStraw( DyeDepotBlocks.TEAL_JACK_O_STRAW, "Teal");
        generateJackOStraw( DyeDepotBlocks.MINT_JACK_O_STRAW, "Mint");
        generateJackOStraw( DyeDepotBlocks.AQUA_JACK_O_STRAW, "Aqua");
        generateJackOStraw( DyeDepotBlocks.SLATE_JACK_O_STRAW, "Slate");
        generateJackOStraw( DyeDepotBlocks.NAVY_JACK_O_STRAW, "Navy");
        generateJackOStraw( DyeDepotBlocks.INDIGO_JACK_O_STRAW, "Indigo");

        generateJackOStraw( DelicateDyesBlocks.CORAL_JACK_O_STRAW, "Coral");
        generateJackOStraw( DelicateDyesBlocks.CANARY_JACK_O_STRAW, "Canary");
        generateJackOStraw( DelicateDyesBlocks.WASABI_JACK_O_STRAW, "Wasabi");
        generateJackOStraw( DelicateDyesBlocks.SACRAMENTO_JACK_O_STRAW, "Sacramento");
        generateJackOStraw( DelicateDyesBlocks.SKY_JACK_O_STRAW, "Sky");
        generateJackOStraw( DelicateDyesBlocks.BLURPLE_JACK_O_STRAW, "Blurple");
        generateJackOStraw( DelicateDyesBlocks.SANGRIA_JACK_O_STRAW, "Sangria");
        generateJackOStraw( DelicateDyesBlocks.ROSE_JACK_O_STRAW, "Rose");
