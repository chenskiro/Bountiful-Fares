    ...
    private CabinetBlockEntity(BlockEntityType<?> type, BlockPos blockPos, BlockState blockState) {
        ...
        this.viewerManager = new ContainerOpenersCounter() {
            protected void onOpen(Level world, BlockPos pos, BlockState state) {
                SoundEvent lazy_open = BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.tryBuild(BountifulFares.FARMERS_DELIGHT_MOD_ID, "block.cabinet.open"));
            ...
            protected void onClose(Level world, BlockPos pos, BlockState state) {
                SoundEvent lazy_close = BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.tryBuild(BountifulFares.FARMERS_DELIGHT_MOD_ID, "block.cabinet.close"));
