...
public class HangingHoaryAppleBlock extends HangingFruitBlock {
    private static final VoxelShape[] SHAPES = new VoxelShape[]{
            ...
            Block.box(6.5, 12.75, 6.5, 9.5, 15.75, 9.5),
    ...
    public InteractionResult onUse(BlockState state, Level world, BlockPos pos, Player player, BlockHitResult hit) {
        ...
        if (i == 4) {
            HangingFruitBlock.popResource(world, pos, new ItemStack(BFItems.HOARY_APPLE, 1));
            world.playSound(null, pos, BFSounds.HANGING_FRUIT_PICK, SoundSource.BLOCKS, 1.0f, 0.7f + world.random.nextFloat() * 0.4f);
    ...
    public ItemStack getPickStack(LevelReader world, BlockPos pos, BlockState state) {
        return new ItemStack(BFItems.HOARY_APPLE);
    }
}
