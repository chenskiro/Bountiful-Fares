...
public class BountifulFaresDataGenerator implements DataGeneratorEntrypoint {
    ...
    public void buildRegistry(RegistrySetBuilder registryBuilder) {
        registryBuilder.add(Registries.CONFIGURED_FEATURE, BFConfiguredFeatures::bootstrap);
        registryBuilder.add(Registries.PLACED_FEATURE, BFPlacedFeatures::bootstrap);
    }
}
