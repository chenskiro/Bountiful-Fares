...
public class DungeonsDelightBlocks {
    public static DeferredHolder<Block,Block> WORMWOOD_PICKETS = registerBlock("wormwood_pickets", ()->new CompatPicketsBlock(BountifulFares.DUNGEONS_DELIGHT_MOD_ID, BlockBehaviour.Properties.ofFullCopy(BFBlocks.OAK_PICKETS.get())));
