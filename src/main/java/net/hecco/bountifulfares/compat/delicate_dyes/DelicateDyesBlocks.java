...
public class DelicateDyesBlocks {
    ...
    public static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.tryBuild(DELICATE_DYES_MOD_ID, name), block);
    }
    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.tryBuild(DELICATE_DYES_MOD_ID, name), new CompatBlockItem(DELICATE_DYES_MOD_ID, block, new Item.Properties()));
    }
