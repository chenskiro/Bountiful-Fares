...
public class SpawnBlocks {
    public static DeferredHolder<Block,Block> ROTTEN_PICKETS = registerBlock("rotten_pickets",()-> new CompatPicketsBlock(SPAWN_MOD_ID, BlockBehaviour.Properties.ofFullCopy(BFBlocks.OAK_PICKETS.get())));
    ...
    public static DeferredHolder<Block,Block> registerBlock(String name, Supplier<Block> block) {
        DeferredHolder<Block,Block> blockRegistryObject = BFBlocks.attachCache(BuiltInRegistries.BLOCK, ResourceLocation.tryBuild(BountifulFares.SPAWN_MOD_ID, name), block);
