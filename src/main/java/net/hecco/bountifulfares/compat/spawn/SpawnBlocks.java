...
public class SpawnBlocks {
    ...
    public static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.tryBuild(SPAWN_MOD_ID, name), block);
    }
    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.tryBuild(SPAWN_MOD_ID, name), new CompatBlockItem(SPAWN_MOD_ID, block, new Item.Properties()));
    }
