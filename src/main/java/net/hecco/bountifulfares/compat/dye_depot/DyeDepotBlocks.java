...
public class DyeDepotBlocks {
    ...
    public static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.tryBuild(DYE_DEPOT_MOD_ID, name), block);
    }
    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.tryBuild(DYE_DEPOT_MOD_ID, name), new CompatBlockItem(DYE_DEPOT_MOD_ID, block, new Item.Properties()));
    }
