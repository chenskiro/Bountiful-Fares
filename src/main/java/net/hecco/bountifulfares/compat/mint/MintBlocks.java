...
public class MintBlocks {
    ...
    public static Block registerBlock(String name, Block block) {
        ...
        return BFBlocks.attachCache(BuiltInRegistries.BLOCK, ResourceLocation.tryBuild(ELS_AND_LS_DYES_MOD_ID, name), block);
    }
    private static void registerBlockItem(String name, Block block) {
        BFBlocks.attachCache(BuiltInRegistries.ITEM, ResourceLocation.tryBuild(ELS_AND_LS_DYES_MOD_ID, name), new CompatBlockItem(ELS_AND_LS_DYES_MOD_ID, block, new Item.Properties()));
    }
