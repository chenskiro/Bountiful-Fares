...
public class MintBlocks {
    public static Block ACORN_JACK_O_STRAW = registerBlock("acorn_jack_o_straw", new CompatJackOStrawBlock(ELS_AND_LS_DYES_MOD_ID, BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_YELLOW).strength(0.5F).lightLevel(createLightLevelFromLitBlockState(12)).instrument(NoteBlockInstrument.BASS).notSolid().nonOpaque().pistonBehavior(PushReaction.DESTROY)));
    ...
    public static Block WINTERGREEN_PICKETS = registerBlock("wintergreen_pickets", new CompatPicketsBlock(ELS_AND_LS_DYES_MOD_ID, BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.NONE).strength(0.5F).sound(BFSounds.LIGHT_WOOD).instrument(NoteBlockInstrument.BASS).notSolid().nonOpaque()));
    ...
    public static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.tryBuild(ELS_AND_LS_DYES_MOD_ID, name), block);
    }
    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.tryBuild(ELS_AND_LS_DYES_MOD_ID, name), new CompatBlockItem(ELS_AND_LS_DYES_MOD_ID, block, new Item.Properties()));
    }
