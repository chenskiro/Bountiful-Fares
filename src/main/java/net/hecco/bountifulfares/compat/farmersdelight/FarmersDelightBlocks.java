...
public class FarmersDelightBlocks {
    public static final Block WALNUT_CABINET = registerBlock("walnut_cabinet", new CabinetBlock(FARMERS_DELIGHT_MOD_ID, BlockBehaviour.Properties.copy(Blocks.BARREL).mapColor(MapColor.COLOR_BROWN)));
    public static final Block HOARY_CABINET = registerBlock("hoary_cabinet", new CabinetBlock(FARMERS_DELIGHT_MOD_ID, BlockBehaviour.Properties.copy(Blocks.BARREL).mapColor(MapColor.TERRACOTTA_GRAY)));
