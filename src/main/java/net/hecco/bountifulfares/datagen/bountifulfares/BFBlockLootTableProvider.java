...
//    public static final LootCondition.Builder WITH_FORTUNE = MatchToolLootCondition.builder(net.minecraft.predicate.item.ItemPredicate.Builder.create().enchantment(new EnchantmentPredicate(Enchantments.FORTUNE, NumberRange.IntRange.atLeast(1))));
    ...
    public void generate() {
        ...
        add(BFBlocks.GOLDEN_APPLE_LEAVES, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                ...
                .with(LootItem.lootTableItem(BFBlocks.GOLDEN_APPLE_LEAVES))));
        add(BFBlocks.FLOWERING_GOLDEN_APPLE_LEAVES, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                .when(this.createWithShearsOrSilkTouchCondition())
                .with(LootItem.lootTableItem(BFBlocks.FLOWERING_GOLDEN_APPLE_LEAVES))));
        ...
        add(BFBlocks.HOARY_LEAVES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .with((this.applyExplosionDecay(BFBlocks.HOARY_LEAVES, LootItem.lootTableItem(Items.STICK)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))))
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .when(this.createWithShearsOrSilkTouchCondition())
                        .with(LootItem.lootTableItem(BFBlocks.HOARY_LEAVES))));
...
//                                        .properties(StatePredicate.Builder.create().exactMatch(WildMaizeBlock.HALF, DoubleBlockHalf.LOWER)))
                                .when(this.createWithoutShearsOrSilkTouchCondition())
                                .with(this.applyExplosionDecay(BFBlocks.WILD_MAIZE, LootItem.lootTableItem(BFItems.MAIZE_SEEDS))))
                        .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
//                                .conditionally(BlockStatePropertyLootCondition.builder(ModBlocks.WILD_MAIZE)
//                                        .properties(StatePredicate.Builder.create().exactMatch(WildMaizeBlock.HALF, DoubleBlockHalf.LOWER)))
                                .when(this.createWithShearsOrSilkTouchCondition())
                                .with(this.applyExplosionDecay(BFBlocks.WILD_MAIZE, LootItem.lootTableItem(BFBlocks.WILD_MAIZE)))));
        ...
        add(BFBlocks.PRISMARINE_BLOSSOM, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(3.0F))
                        ...
                        .with(this.applyExplosionDecay(BFBlocks.PRISMARINE_BLOSSOM, LootItem.lootTableItem(Items.PRISMARINE_CRYSTALS)).setWeight(4))
                        .with(this.applyExplosionDecay(BFBlocks.PRISMARINE_BLOSSOM, LootItem.lootTableItem(Items.PRISMARINE_SHARD)).setWeight(2))
...
//                            .conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, PRISMARINE_DROP_CHANCE)))
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .with(LootItem.lootTableItem(BFBlocks.PRISMARINE_BLOSSOM))));
        ...
        add(BFBlocks.GRASSY_DIRT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .when(this.createWithoutSilkTouchCondition())
                        .with(this.applyExplosionDecay(BFBlocks.GRASSY_DIRT, LootItem.lootTableItem(Blocks.DIRT))))
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .when(this.createSilkTouchCondition())
                        .with(this.applyExplosionDecay(BFBlocks.GRASSY_DIRT, LootItem.lootTableItem(BFBlocks.GRASSY_DIRT)))));
