...
//        TrellisUtil.registerTrellisModels(blockStateModelGenerator, BFTrellises.PALM);
        ...
        blockStateModelGenerator.delegateItemModel(ExcessiveBuildingBlocks.WALNUT_MULCH_BRICKS, ResourceLocation.tryBuild(BountifulFares.EXCESSIVE_BUILDING_MOD_ID, "block/walnut_mulch_bricks"));
        ...
        blockStateModelGenerator.delegateItemModel(ExcessiveBuildingBlocks.PALM_MULCH_BRICKS, ResourceLocation.tryBuild(BountifulFares.EXCESSIVE_BUILDING_MOD_ID, "block/palm_mulch_bricks"));
