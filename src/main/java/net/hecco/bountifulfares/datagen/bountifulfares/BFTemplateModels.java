...
public class BFTemplateModels {
    ...
    public static final ModelTemplate TEMPLATE_PICKETS = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_pickets").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE);
    public static final ModelTemplate TEMPLATE_TRELLIS = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_trellis").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE);
    public static final ModelTemplate TEMPLATE_TRELLIS_0 = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_planted_trellis_0").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.CROP);
    public static final ModelTemplate TEMPLATE_TRELLIS_1 = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_planted_trellis").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.CROP, TextureSlot.FRONT);
    public static final ModelTemplate TEMPLATE_TRELLIS_UPSIDE_DOWN = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_planted_trellis_upside_down").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE, TextureSlot.CROP, TextureSlot.FRONT);
    ...
    public static void registerFruitLogModels(BlockModelGenerators blockStateModelGenerator, Block log, Block wood, Block leaves) {
        ...
        ResourceLocation template_fruit_log = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_log").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).create(logID.withPrefix("block/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
        ResourceLocation template_fruit_log_noside = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_log_noside").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).create(ResourceLocation.tryBuild(logID.getNamespace(), logID.getPath() + "_noside").withPrefix("block/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
        ResourceLocation template_fruit_log_otherside = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_log_otherside").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).create(ResourceLocation.tryBuild(logID.getNamespace(), logID.getPath() + "_otherside").withPrefix("block/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
        ResourceLocation template_fruit_log_side = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_log_side").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).create(ResourceLocation.tryBuild(logID.getNamespace(), logID.getPath() + "_side").withPrefix("block/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
        ResourceLocation template_fruit_wood_otherside = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_wood_otherside").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).create(ResourceLocation.tryBuild(logID.getNamespace(), woodID.getPath() + "_otherside").withPrefix("block/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
        ResourceLocation template_fruit_wood_side = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_wood_side").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).create(ResourceLocation.tryBuild(logID.getNamespace(), woodID.getPath() + "_side").withPrefix("block/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
        new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_log").withPrefix("item/")), Optional.empty(), TextureSlot.TEXTURE).create(logID.withPrefix("item/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
        new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "template_fruit_wood").withPrefix("item/")), Optional.empty(), TextureSlot.TEXTURE).create(woodID.withPrefix("item/"), TextureMapping.defaultTexture(log), blockStateModelGenerator.modelOutput);
    ...
    public static void registerJackOStrawModels(BlockModelGenerators blockStateModelGenerator, Block block) {
        ResourceLocation lowerModel = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "jack_o_straw_lower").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).createWithSuffix(block, "_lower", TextureMapping.defaultTexture(block), blockStateModelGenerator.modelOutput);
        ResourceLocation upperModel = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "jack_o_straw_upper").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).createWithSuffix(block, "_upper", TextureMapping.defaultTexture(block), blockStateModelGenerator.modelOutput);
        ResourceLocation upperLitModel = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "jack_o_straw_upper").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).createWithSuffix(block, "_upper_lit", TextureMapping.defaultTexture(BuiltInRegistries.BLOCK.getKey(block).withPath((path) -> "block/" + path + "_lit")), blockStateModelGenerator.modelOutput);
        new ModelTemplate(Optional.of(ResourceLocation.tryBuild(BountifulFares.MOD_ID, "jack_o_straw_inventory").withPrefix("block/")), Optional.empty(), TextureSlot.TEXTURE).create(BuiltInRegistries.BLOCK.getKey(block).withPrefix("item/"), TextureMapping.defaultTexture(block), blockStateModelGenerator.modelOutput);
    ...
    public static void registerCropTrellis(BlockModelGenerators blockStateModelGenerator, Block trellis, String trellisId, String vinesId, String foliageId, String modId){
        ResourceLocation modelID1 = TEMPLATE_TRELLIS_0.create(trellis, TextureMapping.defaultTexture(trellis).put(TextureSlot.TEXTURE, ResourceLocation.tryBuild(modId, "block/" + trellisId)).put(TextureSlot.CROP, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + vinesId + "_0")), blockStateModelGenerator.modelOutput);
        ResourceLocation modelID2 = TEMPLATE_TRELLIS_1.createWithSuffix(trellis, "_1", TextureMapping.defaultTexture(trellis).put(TextureSlot.TEXTURE, ResourceLocation.tryBuild(modId, "block/" + trellisId)).put(TextureSlot.CROP, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + vinesId + "_1")).put(TextureSlot.FRONT, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + foliageId + "_1")), blockStateModelGenerator.modelOutput);
        ResourceLocation modelID3 = TEMPLATE_TRELLIS_1.createWithSuffix(trellis, "_2", TextureMapping.defaultTexture(trellis).put(TextureSlot.TEXTURE, ResourceLocation.tryBuild(modId, "block/" + trellisId)).put(TextureSlot.CROP, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + vinesId + "_1")).put(TextureSlot.FRONT, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + foliageId + "_2")), blockStateModelGenerator.modelOutput);
        ResourceLocation modelID4 = TEMPLATE_TRELLIS_1.createWithSuffix(trellis, "_3", TextureMapping.defaultTexture(trellis).put(TextureSlot.TEXTURE, ResourceLocation.tryBuild(modId, "block/" + trellisId)).put(TextureSlot.CROP, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + vinesId + "_1")).put(TextureSlot.FRONT, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + foliageId + "_3")), blockStateModelGenerator.modelOutput);
    ...
    public static void registerDecorTrellis(BlockModelGenerators blockStateModelGenerator, Block trellis, String trellisId, String vinesId, String foliageId, String modId){
        ResourceLocation modelID4 = TEMPLATE_TRELLIS_1.create(trellis, TextureMapping.defaultTexture(trellis).put(TextureSlot.TEXTURE, ResourceLocation.tryBuild(modId, "block/" + trellisId)).put(TextureSlot.CROP, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + vinesId)).put(TextureSlot.FRONT, ResourceLocation.tryBuild(BountifulFares.MOD_ID, "block/" + foliageId)), blockStateModelGenerator.modelOutput);
