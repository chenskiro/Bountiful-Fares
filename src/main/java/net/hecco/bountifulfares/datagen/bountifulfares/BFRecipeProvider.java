...
//                    ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, TrellisUtilProvider.getTrellisFromVariant(trellis))
//                            .pattern("# #")
//                            .pattern(" P ")
//                            .pattern("# #")
//                            .input('#', Items.STICK)
...
//            }
//        }
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.OAK);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.SPRUCE);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.BIRCH);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.JUNGLE);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.ACACIA);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.DARK_OAK);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.MANGROVE);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.CHERRY);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.BAMBOO);
        TrellisUtilProvider.registerTrellisRecipe(exporter, BFTrellises.WALNUT);
