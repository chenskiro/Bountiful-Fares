...
public class BFItemTagProvider extends ItemTagsProvider {
    ...
    public BFItemTagProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> providerCompletableFuture, CompletableFuture<TagsProvider.TagLookup<Block>> tagLookupCompletableFuture) {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        tag(BFItemTags.C_FLOUR)
                .add(BFItems.FLOUR.get())
        ;
        tag(BFItemTags.C_MILKS)
        ...
        tag(BFItemTags.C_WALNUTS)
                .add(BFItems.WALNUT.get())
                .addOptional(ResourceLocation.tryBuild("nomansland", "walnuts"))
        ;

        tag(BFItemTags.C_ORANGES)
                .add(BFItems.ORANGE.get())
                .addOptional(ResourceLocation.tryBuild("atmospheric", "orange"))
                .addOptional(ResourceLocation.tryBuild("atmospheric", "blood_orange"))
        ;

        tag(BFItemTags.C_LEMONS)
                .add(BFItems.LEMON.get())
        ;

        tag(BFItemTags.C_PLUMS)
                .add(BFItems.PLUM.get())
                .addOptional(ResourceLocation.tryBuild("environmental", "plum"))
        ;

        tag(BFItemTags.C_PASSION_FRUIT)
                .add(BFItems.PASSION_FRUIT.get())
                .addOptional(ResourceLocation.tryBuild("atmospheric", "passion_fruit"))
        ;

        tag(BFItemTags.C_ELDERBERRIES)
                .add(BFItems.ELDERBERRIES.get())
        ;

        tag(BFItemTags.C_CORN)
        ...
        ;
        tag(ItemTags.FENCE_GATES).add(BFBlocks.HOARY_FENCE_GATE.get().asItem());
        tag(ItemTags.SMALL_FLOWERS).add(BFBlocks.HONEYSUCKLE.get().asItem(), BFBlocks.VIOLET_BELLFLOWER.get().asItem());
        tag(ItemTags.LEAVES)
        ...
        tag(ItemTags.PLANKS).add(BFBlocks.HOARY_PLANKS.get().asItem(), BFBlocks.WALNUT_PLANKS.get().asItem());
        tag(ItemTags.WOODEN_BUTTONS).add(BFBlocks.HOARY_BUTTON.get().asItem(), BFBlocks.WALNUT_BUTTON.get().asItem());
        tag(ItemTags.WOODEN_DOORS).add(BFBlocks.HOARY_DOOR.get().asItem(), BFBlocks.WALNUT_DOOR.get().asItem());
        tag(ItemTags.WOODEN_FENCES).add(BFBlocks.HOARY_FENCE.get().asItem(), BFBlocks.WALNUT_FENCE.get().asItem());
        tag(ItemTags.WOODEN_PRESSURE_PLATES).add(BFBlocks.HOARY_PRESSURE_PLATE.get().asItem(), BFBlocks.WALNUT_PRESSURE_PLATE.get().asItem());
        tag(ItemTags.WOODEN_SLABS).add(BFBlocks.HOARY_SLAB.get().asItem(), BFBlocks.WALNUT_SLAB.get().asItem());
        tag(ItemTags.WOODEN_STAIRS).add(BFBlocks.HOARY_STAIRS.get().asItem(), BFBlocks.WALNUT_STAIRS.get().asItem());
        tag(ItemTags.WOODEN_TRAPDOORS).add(BFBlocks.HOARY_TRAPDOOR.get().asItem(), BFBlocks.WALNUT_TRAPDOOR.get().asItem());
        tag(ItemTags.BUTTONS).add(BFBlocks.CERAMIC_BUTTON.get().asItem());
        ...
        tag(BFItemTags.LEMON_LEAVES).add(BFBlocks.LEMON_LEAVES.get().asItem(), BFBlocks.FLOWERING_LEMON_LEAVES.get().asItem());
        tag(BFItemTags.PLUM_LEAVES).add(BFBlocks.PLUM_LEAVES.get().asItem(), BFBlocks.FLOWERING_PLUM_LEAVES.get().asItem());
        tag(BFItemTags.GOLDEN_APPLE_LEAVES).add(BFBlocks.GOLDEN_APPLE_LEAVES.get().asItem(), BFBlocks.FLOWERING_GOLDEN_APPLE_LEAVES.get().asItem());
        tag(BFItemTags.APPLE_LOGS)
        ...
        tag(BFItemTags.FRUIT_LOGS)
                ...
                .addTag(BFItemTags.PALM_LOGS)
        ;
        tag(BFItemTags.DYEABLE_CERAMIC_BLOCKS)
                .add(BFBlocks.CERAMIC_TILES.get().asItem())
                .add(BFBlocks.CERAMIC_TILE_STAIRS.get().asItem())
                .add(BFBlocks.CERAMIC_TILE_SLAB.get().asItem())
                .add(BFBlocks.CRACKED_CERAMIC_TILES.get().asItem())
                ...
                .add(BFBlocks.CERAMIC_DISH.get().asItem())
        ;
        tag(BFItemTags.FELSIC_STONES)
                .add(Items.ANDESITE)
                .add(Items.GRANITE)
                .add(Items.DIORITE)
                .add(Items.TUFF)
        ;
        tag(BFItemTags.JACK_O_STRAW_LIGHTABLE)
                .addTag(ItemTags.CANDLES)
                .add(Items.TORCH)
        ;

        tag(BFItemTags.VINE_CROP_SEEDS)
                .add(BFItems.PASSION_FRUIT.get())
                .add(BFItems.ELDERBERRIES.get())
                .add(Items.GLOW_BERRIES)
                .add(BFItems.LAPISBERRY_SEEDS.get())
        ;
        tag(BFItemTags.COOKED_FISHES)
                .add(Items.COOKED_COD)
                .add(Items.COOKED_SALMON)
        ;
        tag(BFItemTags.MEALS)
        ...
        ;
        tag(BFItemTags.GRASS_SEEDS_PLANTABLE_ON)
                .add(Items.DIRT)
        ...
        tag(BFItemTags.SUGAR_INGREDIENTS)
                .add(Items.SUGAR)
