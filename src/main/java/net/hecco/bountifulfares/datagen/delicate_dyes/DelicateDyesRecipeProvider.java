...
public class DelicateDyesRecipeProvider extends ModNameRecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> exporter) {
        ...
        offerJackOStrawRecipes(exporter, DelicateDyesBlocks.SACRAMENTO_JACK_O_STRAW.get(), BuiltInRegistries.ITEM.get(ResourceLocation.tryBuild(DELICATE_DYES_MOD_ID, "sacramento_wool")));
        offerJackOStrawRecipes(exporter, DelicateDyesBlocks.SKY_JACK_O_STRAW.get(), BuiltInRegistries.ITEM.get(ResourceLocation.tryBuild(DELICATE_DYES_MOD_ID, "sky_wool")));
        offerJackOStrawRecipes(exporter, DelicateDyesBlocks.BLURPLE_JACK_O_STRAW.get(), BuiltInRegistries.ITEM.get(ResourceLocation.tryBuild(DELICATE_DYES_MOD_ID, "blurple_wool")));
        offerJackOStrawRecipes(exporter, DelicateDyesBlocks.SANGRIA_JACK_O_STRAW.get(), BuiltInRegistries.ITEM.get(ResourceLocation.tryBuild(DELICATE_DYES_MOD_ID, "sangria_wool")));
