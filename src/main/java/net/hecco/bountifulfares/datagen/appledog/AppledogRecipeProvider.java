...
public class AppledogRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        threeByThreePacker(exporter, RecipeCategory.MISC, AppledogBlocks.APPLEDOG_BLOCK, BuiltInRegistries.ITEM.get(ResourceLocation.tryBuild(APPLEDOG_MOD_ID, "dogapple")));
    }
}
