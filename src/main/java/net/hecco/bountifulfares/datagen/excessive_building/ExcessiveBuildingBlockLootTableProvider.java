...
public class ExcessiveBuildingBlockLootTableProvider extends FabricBlockLootTableProvider {
    public ExcessiveBuildingBlockLootTableProvider(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
    ...
    public void generate() {
        ...
        add(ExcessiveBuildingBlocks.HOARY_MOSAIC_SLAB, createSlabItemTable(ExcessiveBuildingBlocks.HOARY_MOSAIC_SLAB));
        add(ExcessiveBuildingBlocks.WALNUT_MOSAIC_SLAB, createSlabItemTable(ExcessiveBuildingBlocks.WALNUT_MOSAIC_SLAB));
        add(ExcessiveBuildingBlocks.WALNUT_MULCH_BRICK_SLAB, createSlabItemTable(ExcessiveBuildingBlocks.WALNUT_MULCH_BRICK_SLAB));
        add(ExcessiveBuildingBlocks.PALM_MULCH_BRICK_SLAB, createSlabItemTable(ExcessiveBuildingBlocks.PALM_MULCH_BRICK_SLAB));
        picketsDrops(ExcessiveBuildingBlocks.ANCIENT_PICKETS);
