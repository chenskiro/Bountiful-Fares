...
public class ExcessiveBuildingRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        offerPicketsRecipe(exporter, ExcessiveBuildingBlocks.ANCIENT_PICKETS, ResourceLocation.tryBuild(EXCESSIVE_BUILDING_MOD_ID, "ancient_planks"));
    ...
    private static void offerVerticalStairsRecipe(RecipeExporter exporter, ItemLike output, ItemLike input) {
